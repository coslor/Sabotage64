...
A note on project structure: the sabotage64/sabotage64 folder is for CBM PRG Studio, which I used to design the screens. The .sdd files are used by PRG Studio, and they are: game-screen.sdd, sabotage_64_title_screen.sdd, and welcome-screen.sdd. the Generated .bin files are for Oscar64.